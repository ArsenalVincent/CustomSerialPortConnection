...
namespace SerialPortConnection
{
    public partial class Form1 : Form
    {
        ...
        CLog myLog = new CLog();
        bool b_receivce_server_data = false;
        string bigData = "";
        public Form1()
        {
            InitializeComponent();
        ...
        void sp1_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            {
                //输出当前时间
                b_receivce_server_data = true;
                DateTime dt = DateTime.Now;
                //bigData = Get300KData();
                //sp1.WriteLine(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss fff") + "?" + bigData);

                b_receivce_server_data = false;
                ...
                else                                            //'发送16进制按钮'
                {
                    try
                    {
                        ...
                        txtReceive.Text += "[" + DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss fff") + "]" + strRcv + "\r\n";
                        myLog.Write(txtReceive.Text, MsgType.Information);
                    }
